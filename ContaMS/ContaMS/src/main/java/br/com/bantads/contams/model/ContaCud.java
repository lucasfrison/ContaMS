...
public class ContaCud implements Serializable, Comparable<ContaCud>  {
    ...
    private List<MovimentacaoCud> movimentacoes;

	public ContaCud() {
		super();
	}

	public ContaCud(Integer id, Integer clienteId, Integer gerenteId, String numero, Double saldo, Double limite,
			Date dataCriacao, List<MovimentacaoCud> movimentacoes) {
		super();
		this.id = id;
	...
	public List<MovimentacaoCud> getMovimentacoes() {
		return movimentacoes;
	}



	public void setMovimentacoes(List<MovimentacaoCud> movimentacoes) {
		this.movimentacoes = movimentacoes;
	}
